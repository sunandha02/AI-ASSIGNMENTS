...
<slot></slot>
  ...
  <body style="background-color: rgb(255, 255, 255);">
    <iframe id="backgroundImage" src="./ai_assigngment2_files/saved_resource.html"></iframe>
    <ntp-app modules-shown-to-user="" style="--ntp-logo-color: inherit; --color-new-tab-page-attribution-foreground: rgba(0, 0, 0, 1.00); --color-new-tab-page-most-visited-foreground: rgba(0, 0, 0, 1.00);"><template shadowrootmode="open"><!----><!--_html_template_start_--><div id="content">
  <!--?lit$846056999$-->
  <!--?lit$846056999$-->
...
<!--_html_template_end_--></template> 
  ...
  <ntp-logo id="logo"><template shadowrootmode="open"><!----><!--_html_template_start_--><!--?lit$846056999$-->
  <div id="logo"></div>
...
<!--_html_template_end_--></template>
  ...
  <div id="searchboxContainer">
    <cr-searchbox id="searchbox" searchbox-lens-search-enabled="" searchbox-voice-search-enabled_="" searchbox-lens-search-enabled_="" color-source-is-baseline="" shown=""><template shadowrootmode="open"><!--_html_template_start_--><style>
...
<div id="container" style="--tile-background-color: rgba(241, 243, 244, 1.00); --column-count: 4; --row-count: 2;">
  <!--?lit$846056999$--><!---->
    <div class="tile" draggable="true" title="localhost" data-index="0">
      <a draggable="false" href="http://localhost:8888/tree?token=a45a70c79878f1c9f0cf6ed4573cc099a117681ceb50b1d9" aria-label="localhost">
      </a>
      <cr-icon-button id="actionMenuButton" class="icon-more-vert" tabindex="0" title="More actions for localhost shortcut" data-index="0" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
...
<div id="icon">
  <div id="maskedImage"></div>
      ...
      <div class="tile-icon">
        <img draggable="false" alt="" src="chrome://favicon2/?size=24&amp;scaleFactor=1x&amp;showFallbackMonogram=&amp;pageUrl=http%3A%2F%2Flocalhost%3A8888%2Ftree%3Ftoken%3Da45a70c79878f1c9f0cf6ed4573cc099a117681ceb50b1d9">
        <div class="query-tile-icon" draggable="false" hidden=""></div>
      </div>
      <div class="tile-title title-ltr">
        <span><!--?lit$846056999$-->localhost</span>
      </div>
    </div>
  <!----><!---->
    <div class="tile" draggable="true" title="Adobe Acrobat" data-index="1">
      <a draggable="false" href="https://acrobat.adobe.com/?x_api_client_id=bookmark&amp;x_api_client_location=Reader" aria-label="Adobe Acrobat">
      </a>
      <cr-icon-button id="actionMenuButton" class="icon-more-vert" tabindex="0" title="More actions for Adobe Acrobat shortcut" data-index="1" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template></cr-icon-button>
...
<div id="icon">
  <div id="maskedImage"></div>
      ...
      <div class="tile-icon">
        <img draggable="false" alt="" src="chrome://favicon2/?size=24&amp;scaleFactor=1x&amp;showFallbackMonogram=&amp;pageUrl=https%3A%2F%2Facrobat.adobe.com%2F%3Fx_api_client_id%3Dbookmark%26x_api_client_location%3DReader">
        <div class="query-tile-icon" draggable="false" hidden=""></div>
      </div>
      <div class="tile-title title-ltr">
        <span><!--?lit$846056999$-->Adobe Acrobat</span>
      </div>
    </div>
  <!----><!---->
    <div class="tile" draggable="true" title="Google Maps" data-index="2">
      <a draggable="false" href="https://maps.google.com/" aria-label="Google Maps">
      </a>
      <cr-icon-button id="actionMenuButton" class="icon-more-vert" tabindex="0" title="More actions for Google Maps shortcut" data-index="2" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template></cr-icon-button>
...
<div id="icon">
  <div id="maskedImage"></div>
      ...
      <div class="tile-icon">
        <img draggable="false" alt="" src="chrome://favicon2/?size=24&amp;scaleFactor=1x&amp;showFallbackMonogram=&amp;pageUrl=https%3A%2F%2Fmaps.google.com%2F">
        <div class="query-tile-icon" draggable="false" hidden=""></div>
      </div>
      <div class="tile-title title-ltr">
        <span><!--?lit$846056999$-->Google Maps</span>
      </div>
    </div>
  <!----><!---->
    <div class="tile" draggable="true" title="Web Store" data-index="3">
      <a draggable="false" href="https://chrome.google.com/webstore?hl=en" aria-label="Web Store">
      </a>
      <cr-icon-button id="actionMenuButton" class="icon-more-vert" tabindex="0" title="More actions for Web Store shortcut" data-index="3" role="button" aria-disabled="false"><template shadowrootmode="open"><!---->
<div id="icon">
  <div id="maskedImage"></div>
</div></template></cr-icon-button>
...
<div id="icon">
  <div id="maskedImage"></div>
      ...
      <div class="tile-icon">
        <img draggable="false" alt="" src="chrome://favicon2/?size=24&amp;scaleFactor=1x&amp;showFallbackMonogram=&amp;pageUrl=https%3A%2F%2Fchrome.google.com%2Fwebstore%3Fhl%3Den">
        <div class="query-tile-icon" draggable="false" hidden=""></div>
      </div>
      <div class="tile-title title-ltr">
        <span><!--?lit$846056999$-->Web Store</span>
      </div>
    </div>
  <!---->
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    ...
    <div class="tile-title">
      <span><!--?lit$846056999$-->Add shortcut</span>
    </div>
  </cr-button>
...
<!-- This wrapper is necessary, such that the "pulse" animation is not
  ...
  <div id="content-wrapper" part="wrapper">
    ...
    <div slot="title"><!--?lit$846056999$--></div>
...
<div id="error" aria-live="assertive"><!--?lit$846056999$--></div></template></cr-input>
...
<div id="error" aria-live="assertive"><!--?lit$846056999$--></div></template>
      </cr-input>
    </div>
...
<div id="hoverBackground" part="hoverBackground"></div></template>
    <!--?lit$846056999$-->Restore default shortcuts
  </cr-button>
</cr-toast-manager>
<!--_html_template_end_--></template>
      </cr-most-visited>
...
<!--_html_template_end_--></template>
    ...
    <!--?lit$846056999$-->
      <!--?lit$846056999$-->
        <ntp-modules id="modules" modules-shown-to-user="" style="--container-gap: 8px; --container-max-width: 554px;"><template shadowrootmode="open"><!----><!--_html_template_start_--><div id="container">
  <!--?lit$846056999$--><!---->
...
<!--_html_template_end_--></template>
    <!----><ntp-most-relevant-tab-resumption format="medium" style="width: 360px;"><template shadowrootmode="open"><!----><!--_html_template_start_--><ntp-module-header-v2 id="moduleHeaderElementV2" header-text="Continue with these tabs" more-actions-text="More actions for Continue with these tabs"><template shadowrootmode="open"><!----><!--_html_template_start_--><div id="titleContainer">
  <h2 id="title"><!--?lit$846056999$-->Continue with these tabs</h2>
...
<dialog id="dialog" part="dialog" role="application" aria-roledescription="More actions">
 ...
 <g viewBox="0 -960 960 960">
        ...
        <!--?lit$846056999$-->Don't show Continue with these tabs
      </button>
    <!----><!---->
 ...
 <g viewBox="0 -960 960 960">
        ...
        <!--?lit$846056999$-->About this card
      </button>
    <!---->
    <hr id="actionMenuDivider">
  <!----><!---->
    <!--?lit$846056999$--><!---->
      <button class="dropdown-item" id="customize-module" data-action="customize-module" role="menuitem">
 ...
 <g viewBox="0 -960 960 960">
        ...
        <!--?lit$846056999$-->Customize cards
      </button>
    <!---->
    <hr id="actionMenuDivider" hidden="">
  <!---->
</cr-action-menu>
<!--_html_template_end_--></template>
...
<div id="urlVisits">
  <!--?lit$846056999$--><!---->
    <a class="url-visit" href="https://hub.rgukt.ac.in/hub/notice/index/index?page=2" data-index="0">
      <div id="hoverLayer"></div>
      <page-favicon class="icon" size="24" style="background-image: image-set(url(&quot;chrome://favicon2/?size=24&amp;scaleFactor=1x&amp;pageUrl=https%3A%2F%2Fhub.rgukt.ac.in%2Fhub%2Fnotice%2Findex%2Findex%3Fpage%3D2&amp;allowGoogleServerFallback=1&amp;iconUrl=&quot;) 1x, url(&quot;chrome://favicon2/?size=24&amp;scaleFactor=2x&amp;pageUrl=https%3A%2F%2Fhub.rgukt.ac.in%2Fhub%2Fnotice%2Findex%2Findex%3Fpage%3D2&amp;allowGoogleServerFallback=1&amp;iconUrl=&quot;) 2x);"><template shadowrootmode="open"><!----><!--?--></template>
      </page-favicon>
      <div class="url-visit-info">
        <div class="url-visit-title"><!--?lit$846056999$-->Info. Hub | RGUKT Basar</div>
        <div class="url-visit-description">
          <div class="url-visit-domain"><!--?lit$846056999$-->hub.rgukt.ac.in</div>
          <span class="dot">
            &nbsp;•&nbsp;
          </span>
          <div class="url-visit-device">
            <!--?lit$846056999$-->moto g85 5G
          </div>
          <span class="dot">
            &nbsp;•&nbsp;
          </span>
          <span class="url-visit-reason">
            <!--?lit$846056999$-->You visit often
          </span>
        </div>
      </div>
...
<cr-icon><template shadowrootmode="open"><svg id="baseSvg" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none; display: block; width: 100%; height: 100%;" viewBox="0 -960 960 960" class="cr-iconset-svg-icon_" role="none">
 <g viewBox="0 -960 960 960">
  ...
  <!----><!---->
    <a class="url-visit" href="https://www.google.com/search?q=rgukt+basar+hub&amp;oq=&amp;gs_lcrp=_9X&amp;client=ms-android-motorola-rvo3&amp;sourceid=chrome-mobile&amp;ie=UTF-8#ebo=0" data-index="1">
      <div id="hoverLayer"></div>
      <page-favicon class="icon" size="24" style="background-image: image-set(url(&quot;chrome://favicon2/?size=24&amp;scaleFactor=1x&amp;pageUrl=https%3A%2F%2Fwww.google.com%2Fsearch%3Fq%3Drgukt%2Bbasar%2Bhub%26oq%3D%26gs_lcrp%_9X%26client%3Dms-android-motorola-rvo3%26sourceid%3Dchrome-mobile%26ie%3DUTF-8%23ebo%3D0&amp;allowGoogleServerFallback=1&amp;iconUrl=&quot;) 1x, url(&quot;chrome://favicon2/?size=24&amp;scaleFactor=2x&amp;pageUrl=https%3A%2F%2Fwww.google.com%2Fsearch%3Fq%3Drgukt%2Bbasar%2Bhub%26oq%3D%26gs_lcrp%_9X%26client%3Dms-android-motorola-rvo3%26sourceid%3Dchrome-mobile%26ie%3DUTF-8%23ebo%3D0&amp;allowGoogleServerFallback=1&amp;iconUrl=&quot;) 2x);"><template shadowrootmode="open"><!----><!--?--></template>
      </page-favicon>
      <div class="url-visit-info">
        <div class="url-visit-title"><!--?lit$846056999$-->rgukt basar hub - Google Search</div>
        <div class="url-visit-description">
          <div class="url-visit-domain"><!--?lit$846056999$-->google.com</div>
          <span class="dot">
            &nbsp;•&nbsp;
          </span>
          <div class="url-visit-device">
...
<cr-toast id="undoToast" duration="10000"><template shadowrootmode="open"><!----><slot></slot></template>
  <div id="undoToastMessage"><!--?lit$846056999$--></div>
  <!--?lit$846056999$-->
</cr-toast>
<!--_html_template_end_--></template>
        </ntp-modules>
    ...
    <ntp-customize-buttons id="customizeButtons" show-customize-chrome-text="" modules-shown-to-user=""><template shadowrootmode="open"><!----><!--_html_template_start_-->
...
<svg>
  <defs>
    ...
    <rect x="-8" y="-8" width="651" height="80"></rect></clippath>
  </defs>
</svg>
